...
public class PuzzleModTemplateTab extends JPanel {
...
//        GUIUtil.add(this, logo, title, dir, dirSelect, version, install);
        GUIUtil.add(this, title, dir, dirSelect, install);
...
//        y -= setCentered(version, y);
    ...
    public PuzzleModTemplateTab setTitle(String title) {
        this.title.setText(title);
        return this;
    }

    public PuzzleModTemplateTab setLogo(ImageIcon icon) {
//        logo.setIcon(icon);
        return this;
    }

    public PuzzleModTemplateTab setVersion(String ver) {
//        version.setText(ver);
        return this;
    }
